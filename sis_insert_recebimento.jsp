...
<table align="center" style="width:450px; height:200px; border:1px solid #333">
 ...
 <form name="form1" method="post" action="sis_insert_manager_recebimento.jsp" onsubmit="return verForm(this)">
 ...
 <%} %>
  ...
  <tr>
    <td width="95" align="left">Cliente</td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><input type="text" name="observacao" maxlength="82" style="width:280px; height:100px" /></td>
  </tr>
  <tr>
    <td align="left"></td>
    <td colspan="3" align="left">&nbsp;</td>
