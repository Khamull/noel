...
<tr>
 ...
 <input type="button" class="botao" onclick="javascript: window.location.href='sis_conta_receber_separada.jsp'" value="Contas a Receber" />
 </td>
</tr>
<tr>
 <td height="25"></td>
...
<table align="center" style="width:450px; height:200px; border:1px solid #333">
 ...
 <form name="form1" method="post" action="sis_insert_manager_recebimento_vale.jsp" onsubmit="return verForm(this)">
 ...
 <%} %>
  <tr>
   <td colspan="4" align="center"><strong>RECEBER ESSA CONTA</strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="79" align="left"><font color="#000099"><%=rs.getString("vendaID") %></font></td>
  ...
  <%} %>
  <tr bgcolor="#CCCCCC">
    <td colspan="4" align="center" valign="top"><strong>VALOR RECEBIDO</strong></td>
  </tr>
  <tr>
    <td colspan="4" align="center" valign="top"><input type="text" name="valorRecebido" maxlength="8" size="20" onkeypress="return numero(this);" value="<%=rs.getString("valor").replace(".",",")%>" /></td>
  </tr>
  <tr bgcolor="#CCCCCC">
    <td colspan="4" align="center" valign="top"><strong>INFORME EM QUAL BANCO VOC&Ecirc; RECEBEU ESSE VALOR</strong></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <input type="hidden" name="acrescimo" />
