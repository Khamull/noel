...
rs02 = st02.executeQuery(cliente.clientePorID());
%>
...
<!--INICIO DO FORMULÁRIO DE VENDAS-->
 <form name="form1" method="post" action="sis_finalizar_manager_servico.jsp" id="form1" onSubmit="return verForm(this)">
   <table width="985" height="440" >
    <tr>
     <td height="20" colspan="2" align="center"><strong>PAGAR E FINALIZAR SERVI&Ccedil;O</strong></td>
    </tr>
    <tr>
     <td valign="top">
