     ...
     <td valign="top">
      ...
      <table align="center">
       ...
       <tr>
        ...
        <td align="left"><div id="inscMunInput" style="display:none"><input type="text" name="clienteInscMunicipal" id="clienteInscMunicipal" size="14" maxlength="14" style="width:120px" onKeyPress="return numero(this)"></div></td>
       </tr>
       <tr>
