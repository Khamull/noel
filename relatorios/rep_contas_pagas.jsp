...
if(formPagamento.equals("0")){
	rs02 = st02.executeQuery(pagar.contaPaga(dataInicio, dataFim));
	rs03 = st03.executeQuery(pagar.contaPaga(dataInicio, dataFim));
}else{
	//atribui a forma de pagamento ao Objeto pagar
	pagar.forma.formPagID = Integer.parseInt(formPagamento);
	rs02 = st02.executeQuery(pagar.contaPagasPorForma(dataInicio, dataFim));
	rs03 = st03.executeQuery(pagar.contaPagasPorForma(dataInicio, dataFim));
}
...
while(rs03.next()){
	lancamento2.pagar.pagarID = rs03.getInt("pagarID");
	//Pesquisa o valor pago por Essa Divida
	rs05 = st05.executeQuery(lancamento2.contasPagas());
	if(rs05.next()){
   ...
   <table width="590" height="950" cellpadding="0" cellspacing="0" style="border:1px solid none" align="center">
    <tr>
     <td align="center" valign="top" height="120">
      ...
      <table width="585" height="120" border="0" align="center" cellpadding="0" cellspacing="0">
       ...
       <tr>
        <td height="15" colspan="3" align="center"><strong>RELATORIO - CONTAS PAGAS ( de <%=data.converteDeData(dataInicio) %>&nbsp;&nbsp; &agrave; &nbsp;&nbsp;<%=data.converteDeData(dataFim) %> ) - TOTAL: <%=valTotal%></strong></td>
       </tr>
       <tr>
        <td align="center" colspan="3"><hr></td>
       </tr>
    ...
    <tr>
     ...
     <%ln++; %>
      ...
      lancamento.pagar.pagarID = rs02.getInt("pagarID");
      
      //Pesquisa informações sobre o lançamento dessa conta Recebida
      rs04 = st04.executeQuery(lancamento.contasPagas());
      ...
      %>
       <tr>
        ...
        <td height="15" align="left"><strong>Desconto</strong></td>
