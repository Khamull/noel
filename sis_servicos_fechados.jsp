...
<tr>
 ...
 <input type="button" class="botao" onclick="javascript: window.location.href='sis_view_servicos.jsp'" value="Lista Servi&ccedil;os" />
 </td>
</tr>
<tr>
 <td height="25"></td>
...
<tr>
 ...
 <table>
  ...
  <tr bgcolor="#EEEEEE">
   <td width="92" align="left"><strong>N&deg; O.S.</strong></td>
  ...
  %>
   ...
   <tr>
   <td width="92" height="30" align="left" valign="middle"><%=rs.getString("servicoID")%></td>
...
&Aacute; Vista
  ...
  <%}%></td>
   ...
   <td width="36" height="30" align="center" valign="middle"><a href="sis_print_servico_fechado.jsp?servicoID=<%=rs.getString("servicoID")%>" title="Imprimir Cupom"><img src="ico/ico_print.png" width="20" height="20" border="0" /></a></td>
  </tr>
  <tr>
